create user enbdba identified by 12;
grant dba to enbdba;
...
CREATE OR REPLACE VIEW SYS.ENBDBA_ASM_DISKGROUP AS
SELECT NAME,STATE,TOTAL_MB,FREE_MB FROM V$ASM_DISKGROUP;


CREATE OR REPLACE VIEW SYS.ENBDBA_IMPORT_PROGRESS AS
SELECT
...
CREATE OR REPLACE VIEW SYS.ENBDBA_TOP_QUERIES_ELAPSED_TIME AS
SELECT B.USERNAME,
       A.SQL_TEXT,
       A.SQL_FULLTEXT,
       A.SQL_ID,
