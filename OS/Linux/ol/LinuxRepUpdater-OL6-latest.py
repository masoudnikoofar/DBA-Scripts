...
# ===============================list of Localfiles========================================
def FileLister():
	for file in os.listdir("/var/www/html/OracleLinux/6.7/latest/x86_64/getPackage/"):
...
def RemFileLister():
	...
	html_page = urllib2.urlopen("http://public-yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64/")
...
def FileDownloader(a):
	for i in range(len(a)):
 		url = "http://public-yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64/getPackage/" + a[i]
 		print url

 		file_name = url.split('/')[-1]
		u = urllib2.urlopen(url)
		fileinpath="/var/www/html/OracleLinux/6.7/latest/x86_64/getPackage/"+ file_name
